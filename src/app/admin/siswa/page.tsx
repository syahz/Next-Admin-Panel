...
import { columns } from "@/app/admin/siswa/components/columns-siswa";
const Siswa = () => {
  return (
    <main className="lg:gap-6 lg:p-6">
      <div className="flex flex-col md:flex-row items-center justify-between">
        <div className="flex-col">
          <h1 className="text-lg font-semibold md:text-2xl">Data Siswa</h1>
          <p className="hidden md:block text-sm text-foreground font-extralight">Table List data siswa</p>
        </div>
        <Breadcrumbs />
      </div>
